...
class TestMarkdownPy(unittest.TestCase):
    ...
    def test_h1(self):
        '''
        Lines surrounded by one hastag should be wrapped in 'h1' tags
        '''
        self.assertEqual( 
                run_markdown('#this should be wrapped in strong tags'),
                '<p><h1>this should be wrapped in strong tags</h1></p>')    
   
    def test_h2(self):
        '''
        Lines surrounded by two hastag should be wrapped in 'h2' tags
        '''
        self.assertEqual( 
                run_markdown('##this should be wrapped in strong tags'),
    ...
    def test_h3(self):
        '''
        Lines surrounded by three hastag should be wrapped in 'h3' tags
        '''
        self.assertEqual( 
                run_markdown('###this should be wrapped in strong tags'),
                '<p><h3>this should be wrapped in strong tags</h3></p>')        
